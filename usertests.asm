...
iputtest(void)
{
  ...
  printf(stdout, "iput test\n");
      ...
      13:	50                   	push   %eax
      14:	e8 4c 40 00 00       	call   4065 <printf>
  ...
  if(mkdir("iputdir") < 0){
    ...
    printf(stdout, "mkdir failed\n");
      ...
      3d:	50                   	push   %eax
      3e:	e8 22 40 00 00       	call   4065 <printf>
  ...
  if(chdir("iputdir") < 0){
    ...
    printf(stdout, "chdir iputdir failed\n");
      ...
      6c:	50                   	push   %eax
      6d:	e8 f3 3f 00 00       	call   4065 <printf>
  ...
  if(unlink("../iputdir") < 0){
    ...
    printf(stdout, "unlink ../iputdir failed\n");
      ...
      9b:	50                   	push   %eax
      9c:	e8 c4 3f 00 00       	call   4065 <printf>
  ...
  if(chdir("/") < 0){
    ...
    printf(stdout, "chdir / failed\n");
      ...
      ca:	50                   	push   %eax
      cb:	e8 95 3f 00 00       	call   4065 <printf>
  ...
  printf(stdout, "iput test ok\n");
      ...
      e5:	50                   	push   %eax
      e6:	e8 7a 3f 00 00       	call   4065 <printf>
...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test\n");
     ...
     104:	50                   	push   %eax
     105:	e8 5b 3f 00 00       	call   4065 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     128:	50                   	push   %eax
     129:	e8 37 3f 00 00       	call   4065 <printf>
  ...
  if(pid == 0){
    ...
    if(mkdir("iputdir") < 0){
     ...
     161:	50                   	push   %eax
     162:	e8 fe 3e 00 00       	call   4065 <printf>
    ...
    if(chdir("iputdir") < 0){
     ...
     190:	50                   	push   %eax
     191:	e8 cf 3e 00 00       	call   4065 <printf>
    ...
    if(unlink("../iputdir") < 0){
     ...
     1bf:	50                   	push   %eax
     1c0:	e8 a0 3e 00 00       	call   4065 <printf>
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     1e4:	50                   	push   %eax
     1e5:	e8 7b 3e 00 00       	call   4065 <printf>
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test\n");
     ...
     203:	50                   	push   %eax
     204:	e8 5c 3e 00 00       	call   4065 <printf>
  ...
  if(mkdir("oidir") < 0){
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     22d:	50                   	push   %eax
     22e:	e8 32 3e 00 00       	call   4065 <printf>
  ...
  if(pid < 0){
    ...
    printf(stdout, "fork failed\n");
     ...
     256:	50                   	push   %eax
     257:	e8 09 3e 00 00       	call   4065 <printf>
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     292:	50                   	push   %eax
     293:	e8 cd 3d 00 00       	call   4065 <printf>
  ...
  if(unlink("oidir") != 0){
    ...
    printf(stdout, "unlink failed\n");
     ...
     2d3:	50                   	push   %eax
     2d4:	e8 8c 3d 00 00       	call   4065 <printf>
  ...
  printf(stdout, "openiput test ok\n");
     ...
     2f3:	50                   	push   %eax
     2f4:	e8 6c 3d 00 00       	call   4065 <printf>
...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
     ...
     312:	50                   	push   %eax
     313:	e8 4d 3d 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "open echo failed!\n");
     ...
     343:	50                   	push   %eax
     344:	e8 1c 3d 00 00       	call   4065 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     387:	50                   	push   %eax
     388:	e8 d8 3c 00 00       	call   4065 <printf>
  ...
  printf(stdout, "open test ok\n");
     ...
     3a2:	50                   	push   %eax
     3a3:	e8 bd 3c 00 00       	call   4065 <printf>
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
     ...
     3c1:	50                   	push   %eax
     3c2:	e8 9e 3c 00 00       	call   4065 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     3f5:	50                   	push   %eax
     3f6:	e8 6a 3c 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     417:	50                   	push   %eax
     418:	e8 48 3c 00 00       	call   4065 <printf>
    ...
    if(write(fd, "aaaaaaaaaa", 10) != 10){
     ...
     44f:	50                   	push   %eax
     450:	e8 10 3c 00 00       	call   4065 <printf>
    ...
    if(write(fd, "bbbbbbbbbb", 10) != 10){
     ...
     487:	50                   	push   %eax
     488:	e8 d8 3b 00 00       	call   4065 <printf>
  ...
  printf(stdout, "writes ok\n");
     ...
     4ac:	50                   	push   %eax
     4ad:	e8 b3 3b 00 00       	call   4065 <printf>
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     4eb:	50                   	push   %eax
     4ec:	e8 74 3b 00 00       	call   4065 <printf>
  ...
  if(i == 2000){
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     527:	50                   	push   %eax
     528:	e8 38 3b 00 00       	call   4065 <printf>
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     542:	50                   	push   %eax
     543:	e8 1d 3b 00 00       	call   4065 <printf>
  ...
  if(unlink("small") < 0){
    ...
    printf(stdout, "read failed\n");
     ...
     57c:	50                   	push   %eax
     57d:	e8 e3 3a 00 00       	call   4065 <printf>
    ...
    printf(stdout, "unlink small failed\n");
     ...
     597:	50                   	push   %eax
     598:	e8 c8 3a 00 00       	call   4065 <printf>
  ...
  printf(stdout, "small file test ok\n");
     ...
     5b2:	50                   	push   %eax
     5b3:	e8 ad 3a 00 00       	call   4065 <printf>
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
     ...
     5d1:	50                   	push   %eax
     5d2:	e8 8e 3a 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     605:	50                   	push   %eax
     606:	e8 5a 3a 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    if(write(fd, buf, 512) != 512){
     ...
     655:	50                   	push   %eax
     656:	e8 0a 3a 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     6a7:	50                   	push   %eax
     6a8:	e8 b8 39 00 00       	call   4065 <printf>
  ...
  for(;;){
    ...
    if(i == 0){
     ...
     6f6:	50                   	push   %eax
     6f7:	e8 69 39 00 00       	call   4065 <printf>
     ...
     71d:	50                   	push   %eax
     71e:	e8 42 39 00 00       	call   4065 <printf>
    ...
    if(((int*)buf)[0] != n){
     ...
     74c:	50                   	push   %eax
     74d:	e8 13 39 00 00       	call   4065 <printf>
  ...
  if(unlink("big") < 0){
    ...
    printf(stdout, "unlink big failed\n");
     ...
     793:	50                   	push   %eax
     794:	e8 cc 38 00 00       	call   4065 <printf>
  ...
  printf(stdout, "big files ok\n");
     ...
     7ae:	50                   	push   %eax
     7af:	e8 b1 38 00 00       	call   4065 <printf>
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     7cd:	50                   	push   %eax
     7ce:	e8 92 38 00 00       	call   4065 <printf>
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     871:	50                   	push   %eax
     872:	e8 ee 37 00 00       	call   4065 <printf>
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     890:	50                   	push   %eax
     891:	e8 cf 37 00 00       	call   4065 <printf>
  ...
  if(mkdir("dir0") < 0){
    ...
    printf(stdout, "mkdir failed\n");
     ...
     8ba:	50                   	push   %eax
     8bb:	e8 a5 37 00 00       	call   4065 <printf>
  ...
  if(chdir("dir0") < 0){
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     8e9:	50                   	push   %eax
     8ea:	e8 76 37 00 00       	call   4065 <printf>
  ...
  if(chdir("..") < 0){
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     918:	50                   	push   %eax
     919:	e8 47 37 00 00       	call   4065 <printf>
  ...
  if(unlink("dir0") < 0){
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     947:	50                   	push   %eax
     948:	e8 18 37 00 00       	call   4065 <printf>
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     962:	50                   	push   %eax
     963:	e8 fd 36 00 00       	call   4065 <printf>
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
     ...
     981:	50                   	push   %eax
     982:	e8 de 36 00 00       	call   4065 <printf>
  ...
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     9b0:	50                   	push   %eax
     9b1:	e8 af 36 00 00       	call   4065 <printf>
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    printf(1, "pipe() failed\n");
     ...
     9e2:	6a 01                	push   $0x1
     9e4:	e8 7c 36 00 00       	call   4065 <printf>
  ...
  if(pid == 0){
    ...
    for(n = 0; n < 5; n++){
     ...
     a75:	6a 01                	push   $0x1
     a77:	e8 e9 35 00 00       	call   4065 <printf>
    ...
    while((n = read(fds[0], buf, cc)) > 0){
     ...
     aed:	6a 01                	push   $0x1
     aef:	e8 71 35 00 00       	call   4065 <printf>
    ...
    if(total != 5 * 1033){
     ...
     b5a:	6a 01                	push   $0x1
     b5c:	e8 04 35 00 00       	call   4065 <printf>
  ...
  printf(1, "pipe1 ok\n");
     ...
     b85:	6a 01                	push   $0x1
     b87:	e8 d9 34 00 00       	call   4065 <printf>
    ...
    printf(1, "fork() failed\n");
     ...
     b99:	6a 01                	push   $0x1
     b9b:	e8 c5 34 00 00       	call   4065 <printf>
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
     ...
     bb8:	6a 01                	push   $0x1
     bba:	e8 a6 34 00 00       	call   4065 <printf>
  ...
  if(pid3 == 0){
    ...
    if(write(pfds[1], "x", 1) != 1)
     ...
     c31:	6a 01                	push   $0x1
     c33:	e8 2d 34 00 00       	call   4065 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    printf(1, "preempt read error");
     ...
     c81:	6a 01                	push   $0x1
     c83:	e8 dd 33 00 00       	call   4065 <printf>
  ...
  printf(1, "kill... ");
     ...
     ca4:	6a 01                	push   $0x1
     ca6:	e8 ba 33 00 00       	call   4065 <printf>
  ...
  printf(1, "wait... ");
     ...
     ce0:	6a 01                	push   $0x1
     ce2:	e8 7e 33 00 00       	call   4065 <printf>
  ...
  printf(1, "preempt ok\n");
     ...
     d01:	6a 01                	push   $0x1
     d03:	e8 5d 33 00 00       	call   4065 <printf>
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     d32:	6a 01                	push   $0x1
     d34:	e8 2c 33 00 00       	call   4065 <printf>
    ...
    if(pid){
     ...
     d56:	6a 01                	push   $0x1
     d58:	e8 08 33 00 00       	call   4065 <printf>
  ...
  printf(1, "exitwait ok\n");
     ...
     d79:	6a 01                	push   $0x1
     d7b:	e8 e5 32 00 00       	call   4065 <printf>
...
mem(void)
{
  ...
  printf(1, "mem test\n");
     ...
     d93:	6a 01                	push   $0x1
     d95:	e8 cb 32 00 00       	call   4065 <printf>
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     e2c:	6a 01                	push   $0x1
     e2e:	e8 32 32 00 00       	call   4065 <printf>
    ...
    printf(1, "mem ok\n");
     ...
     e5f:	6a 01                	push   $0x1
     e61:	e8 ff 31 00 00       	call   4065 <printf>
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     ...
     e84:	6a 01                	push   $0x1
     e86:	e8 da 31 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for writing");
     ...
     ec4:	6a 01                	push   $0x1
     ec6:	e8 9a 31 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 1000; i++){
    ...
    if(write(fd, buf, sizeof(buf)) != sizeof(buf)){
     ...
     f29:	6a 01                	push   $0x1
     f2b:	e8 35 31 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    printf(1, "fstests: cannot open sharedfd for reading\n");
     ...
     f83:	6a 01                	push   $0x1
     f85:	e8 db 30 00 00       	call   4065 <printf>
  ...
  if(nc == 10000 && np == 10000){
    ...
    1031:	6a 01                	push   $0x1
    1033:	e8 2d 30 00 00       	call   4065 <printf>
    ...
    1048:	6a 01                	push   $0x1
    104a:	e8 16 30 00 00       	call   4065 <printf>
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    ...
    1083:	6a 01                	push   $0x1
    1085:	e8 db 2f 00 00       	call   4065 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    10c7:	6a 01                	push   $0x1
    10c9:	e8 97 2f 00 00       	call   4065 <printf>
    ...
    1104:	6a 01                	push   $0x1
    1106:	e8 5a 2f 00 00       	call   4065 <printf>
    ...
    1167:	6a 01                	push   $0x1
    1169:	e8 f7 2e 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 2; i++){
    ...
    1206:	6a 01                	push   $0x1
    1208:	e8 58 2e 00 00       	call   4065 <printf>
    ...
    126a:	6a 01                	push   $0x1
    126c:	e8 f4 2d 00 00       	call   4065 <printf>
  ...
  printf(1, "fourfiles ok\n");
    ...
    129d:	6a 01                	push   $0x1
    129f:	e8 c1 2d 00 00       	call   4065 <printf>
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    12b8:	6a 01                	push   $0x1
    12ba:	e8 a6 2d 00 00       	call   4065 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    12e4:	6a 01                	push   $0x1
    12e6:	e8 7a 2d 00 00       	call   4065 <printf>
    ...
    1344:	6a 01                	push   $0x1
    1346:	e8 1a 2d 00 00       	call   4065 <printf>
    ...
    139e:	6a 01                	push   $0x1
    13a0:	e8 c0 2c 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < N; i++){
    ...
    1454:	6a 01                	push   $0x1
    1456:	e8 0a 2c 00 00       	call   4065 <printf>
    ...
    1481:	6a 01                	push   $0x1
    1483:	e8 dd 2b 00 00       	call   4065 <printf>
  ...
  printf(1, "createdelete ok\n");
    ...
    150f:	6a 01                	push   $0x1
    1511:	e8 4f 2b 00 00       	call   4065 <printf>
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    152a:	6a 01                	push   $0x1
    152c:	e8 34 2b 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    155a:	6a 01                	push   $0x1
    155c:	e8 04 2b 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    15af:	6a 01                	push   $0x1
    15b1:	e8 af 2a 00 00       	call   4065 <printf>
  ...
  if(unlink("unlinkread") != 0){
    ...
    15da:	6a 01                	push   $0x1
    15dc:	e8 84 2a 00 00       	call   4065 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1649:	6a 01                	push   $0x1
    164b:	e8 15 2a 00 00       	call   4065 <printf>
  ...
  if(buf[0] != 'h'){
    ...
    166b:	6a 01                	push   $0x1
    166d:	e8 f3 29 00 00       	call   4065 <printf>
  ...
  if(write(fd, buf, 10) != 10){
    ...
    169c:	6a 01                	push   $0x1
    169e:	e8 c2 29 00 00       	call   4065 <printf>
  ...
  printf(1, "unlinkread ok\n");
    ...
    16d1:	6a 01                	push   $0x1
    16d3:	e8 8d 29 00 00       	call   4065 <printf>
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    16ec:	6a 01                	push   $0x1
    16ee:	e8 72 29 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    173c:	6a 01                	push   $0x1
    173e:	e8 22 29 00 00       	call   4065 <printf>
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    176d:	6a 01                	push   $0x1
    176f:	e8 f1 28 00 00       	call   4065 <printf>
  ...
  if(link("lf1", "lf2") < 0){
    ...
    17ab:	6a 01                	push   $0x1
    17ad:	e8 b3 28 00 00       	call   4065 <printf>
  ...
  if(open("lf1", 0) >= 0){
    ...
    17e8:	6a 01                	push   $0x1
    17ea:	e8 76 28 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    181a:	6a 01                	push   $0x1
    181c:	e8 44 28 00 00       	call   4065 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    184e:	6a 01                	push   $0x1
    1850:	e8 10 28 00 00       	call   4065 <printf>
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    188c:	6a 01                	push   $0x1
    188e:	e8 d2 27 00 00       	call   4065 <printf>
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    18cc:	6a 01                	push   $0x1
    18ce:	e8 92 27 00 00       	call   4065 <printf>
  ...
  if(link(".", "lf1") >= 0){
    ...
    18fc:	6a 01                	push   $0x1
    18fe:	e8 62 27 00 00       	call   4065 <printf>
  ...
  printf(1, "linktest ok\n");
    ...
    1913:	6a 01                	push   $0x1
    1915:	e8 4b 27 00 00       	call   4065 <printf>
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    192a:	68 d2 4c 00 00       	push   $0x4cd2
    192f:	6a 01                	push   $0x1
    1931:	e8 2f 27 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 40; i++){
    ...
    199d:	50                   	push   %eax
    199e:	68 e2 4c 00 00       	push   $0x4ce2
    ...
    19e3:	50                   	push   %eax
    19e4:	68 e2 4c 00 00       	push   $0x4ce2
    ...
    1a16:	50                   	push   %eax
    1a17:	68 e5 4c 00 00       	push   $0x4ce5
    1a1c:	6a 01                	push   $0x1
    1a1e:	e8 42 26 00 00       	call   4065 <printf>
  ...
  fd = open(".", 0);
    ...
    1a6d:	6a 00                	push   $0x0
    1a6f:	68 a7 4c 00 00       	push   $0x4ca7
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    1acd:	50                   	push   %eax
    1ace:	68 01 4d 00 00       	push   $0x4d01
    1ad3:	6a 01                	push   $0x1
    1ad5:	e8 8b 25 00 00       	call   4065 <printf>
    ...
    1afa:	50                   	push   %eax
    1afb:	68 1a 4d 00 00       	push   $0x4d1a
    1b00:	6a 01                	push   $0x1
    1b02:	e8 5e 25 00 00       	call   4065 <printf>
  ...
  if(n != 40){
    ...
    1b51:	68 38 4d 00 00       	push   $0x4d38
    1b56:	6a 01                	push   $0x1
    1b58:	e8 08 25 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 40; i++){
    ...
    1b8b:	68 bd 44 00 00       	push   $0x44bd
    1b90:	6a 01                	push   $0x1
    1b92:	e8 ce 24 00 00       	call   4065 <printf>
  ...
  printf(1, "concreate ok\n");
    ...
    1cc5:	68 69 4d 00 00       	push   $0x4d69
    1cca:	6a 01                	push   $0x1
    1ccc:	e8 94 23 00 00       	call   4065 <printf>
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    1ce3:	68 77 4d 00 00       	push   $0x4d77
    1ce8:	6a 01                	push   $0x1
    1cea:	e8 76 23 00 00       	call   4065 <printf>
    1cef:	83 c4 10             	add    $0x10,%esp

  unlink("x");
    1cf2:	83 ec 0c             	sub    $0xc,%esp
    1cf5:	68 f3 48 00 00       	push   $0x48f3
  ...
  if(pid < 0){
    ...
    1d13:	68 bd 44 00 00       	push   $0x44bd
    1d18:	6a 01                	push   $0x1
    1d1a:	e8 46 23 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 100; i++){
    ...
    1d7f:	68 f3 48 00 00       	push   $0x48f3
    ...
    1dbc:	68 f3 48 00 00       	push   $0x48f3
    1dc1:	68 88 4d 00 00       	push   $0x4d88
    ...
    1dd3:	68 f3 48 00 00       	push   $0x48f3
  ...
  printf(1, "linkunlink ok\n");
    ...
    1e03:	68 8c 4d 00 00       	push   $0x4d8c
    1e08:	6a 01                	push   $0x1
    1e0a:	e8 56 22 00 00       	call   4065 <printf>
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    1e1e:	68 9b 4d 00 00       	push   $0x4d9b
    1e23:	6a 01                	push   $0x1
    1e25:	e8 3b 22 00 00       	call   4065 <printf>
    1e2a:	83 c4 10             	add    $0x10,%esp
  unlink("bd");
    1e2d:	83 ec 0c             	sub    $0xc,%esp
    1e30:	68 a8 4d 00 00       	push   $0x4da8
  ...
  fd = open("bd", O_CREATE);
    ...
    1e45:	68 a8 4d 00 00       	push   $0x4da8
  ...
  if(fd < 0){
    ...
    1e5e:	68 ab 4d 00 00       	push   $0x4dab
    1e63:	6a 01                	push   $0x1
    1e65:	e8 fb 21 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 500; i++){
    ...
    1ebf:	50                   	push   %eax
    1ec0:	68 a8 4d 00 00       	push   $0x4da8
    ...
    1ed4:	68 c1 4d 00 00       	push   $0x4dc1
    1ed9:	6a 01                	push   $0x1
    1edb:	e8 85 21 00 00       	call   4065 <printf>
  ...
  unlink("bd");
    ...
    1ef8:	68 a8 4d 00 00       	push   $0x4da8
  ...
  for(i = 0; i < 500; i++){
    ...
    1f54:	68 d5 4d 00 00       	push   $0x4dd5
    1f59:	6a 01                	push   $0x1
    1f5b:	e8 05 21 00 00       	call   4065 <printf>
  ...
  printf(1, "bigdir ok\n");
    ...
    1f78:	68 ea 4d 00 00       	push   $0x4dea
    1f7d:	6a 01                	push   $0x1
    1f7f:	e8 e1 20 00 00       	call   4065 <printf>
...
subdir(void)
{
  ...
  if(mkdir("dd") != 0){
    ...
    1fc9:	68 08 4e 00 00       	push   $0x4e08
    1fce:	6a 01                	push   $0x1
    1fd0:	e8 90 20 00 00       	call   4065 <printf>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    1fe5:	68 20 4e 00 00       	push   $0x4e20
  ...
  if(fd < 0){
    ...
    1ffe:	68 26 4e 00 00       	push   $0x4e26
    2003:	6a 01                	push   $0x1
    2005:	e8 5b 20 00 00       	call   4065 <printf>
  ...
  write(fd, "ff", 2);
    ...
    2015:	6a 02                	push   $0x2
    2017:	68 02 4e 00 00       	push   $0x4e02
  ...
  if(unlink("dd") >= 0){
    ...
    2038:	68 05 4e 00 00       	push   $0x4e05
    ...
    204c:	68 3c 4e 00 00       	push   $0x4e3c
    2051:	6a 01                	push   $0x1
    2053:	e8 0d 20 00 00       	call   4065 <printf>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2063:	68 62 4e 00 00       	push   $0x4e62
    ...
    2077:	68 69 4e 00 00       	push   $0x4e69
    207c:	6a 01                	push   $0x1
    207e:	e8 e2 1f 00 00       	call   4065 <printf>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2093:	68 84 4e 00 00       	push   $0x4e84
  ...
  if(fd < 0){
    ...
    20ac:	68 8d 4e 00 00       	push   $0x4e8d
    20b1:	6a 01                	push   $0x1
    20b3:	e8 ad 1f 00 00       	call   4065 <printf>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    20e6:	6a 00                	push   $0x0
    20e8:	68 a8 4e 00 00       	push   $0x4ea8
  ...
  if(fd < 0){
    ...
    2101:	68 b4 4e 00 00       	push   $0x4eb4
    2106:	6a 01                	push   $0x1
    2108:	e8 58 1f 00 00       	call   4065 <printf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2144:	68 cd 4e 00 00       	push   $0x4ecd
    2149:	6a 01                	push   $0x1
    214b:	e8 15 1f 00 00       	call   4065 <printf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2182:	68 f4 4e 00 00       	push   $0x4ef4
    2187:	6a 01                	push   $0x1
    2189:	e8 d7 1e 00 00       	call   4065 <printf>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2199:	68 84 4e 00 00       	push   $0x4e84
    ...
    21ad:	68 15 4f 00 00       	push   $0x4f15
    21b2:	6a 01                	push   $0x1
    21b4:	e8 ac 1e 00 00       	call   4065 <printf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    21c4:	6a 00                	push   $0x0
    21c6:	68 84 4e 00 00       	push   $0x4e84
    ...
    21da:	68 30 4f 00 00       	push   $0x4f30
    21df:	6a 01                	push   $0x1
    21e1:	e8 7f 1e 00 00       	call   4065 <printf>
  ...
  if(chdir("dd") != 0){
    ...
    21f1:	68 05 4e 00 00       	push   $0x4e05
    ...
    2205:	68 54 4f 00 00       	push   $0x4f54
    220a:	6a 01                	push   $0x1
    220c:	e8 54 1e 00 00       	call   4065 <printf>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    221c:	68 65 4f 00 00       	push   $0x4f65
    ...
    2230:	68 71 4f 00 00       	push   $0x4f71
    2235:	6a 01                	push   $0x1
    2237:	e8 29 1e 00 00       	call   4065 <printf>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2247:	68 8b 4f 00 00       	push   $0x4f8b
    ...
    225b:	68 71 4f 00 00       	push   $0x4f71
    2260:	6a 01                	push   $0x1
    2262:	e8 fe 1d 00 00       	call   4065 <printf>
  ...
  if(chdir("./..") != 0){
    ...
    2272:	68 9a 4f 00 00       	push   $0x4f9a
    ...
    2286:	68 9f 4f 00 00       	push   $0x4f9f
    228b:	6a 01                	push   $0x1
    228d:	e8 d3 1d 00 00       	call   4065 <printf>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    229d:	6a 00                	push   $0x0
    229f:	68 e8 4e 00 00       	push   $0x4ee8
  ...
  if(fd < 0){
    ...
    22b8:	68 b2 4f 00 00       	push   $0x4fb2
    22bd:	6a 01                	push   $0x1
    22bf:	e8 a1 1d 00 00       	call   4065 <printf>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    22ec:	68 ca 4f 00 00       	push   $0x4fca
    22f1:	6a 01                	push   $0x1
    22f3:	e8 6d 1d 00 00       	call   4065 <printf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2311:	6a 00                	push   $0x0
    2313:	68 84 4e 00 00       	push   $0x4e84
    ...
    2327:	68 e8 4f 00 00       	push   $0x4fe8
    232c:	6a 01                	push   $0x1
    232e:	e8 32 1d 00 00       	call   4065 <printf>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2343:	68 0d 50 00 00       	push   $0x500d
    ...
    2357:	68 16 50 00 00       	push   $0x5016
    235c:	6a 01                	push   $0x1
    235e:	e8 02 1d 00 00       	call   4065 <printf>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2373:	68 32 50 00 00       	push   $0x5032
    ...
    2387:	68 3b 50 00 00       	push   $0x503b
    238c:	6a 01                	push   $0x1
    238e:	e8 d2 1c 00 00       	call   4065 <printf>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    23a3:	68 05 4e 00 00       	push   $0x4e05
    ...
    23b7:	68 57 50 00 00       	push   $0x5057
    23bc:	6a 01                	push   $0x1
    23be:	e8 a2 1c 00 00       	call   4065 <printf>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    23ce:	6a 02                	push   $0x2
    23d0:	68 05 4e 00 00       	push   $0x4e05
    ...
    23e4:	68 6d 50 00 00       	push   $0x506d
    23e9:	6a 01                	push   $0x1
    23eb:	e8 75 1c 00 00       	call   4065 <printf>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    23fb:	6a 01                	push   $0x1
    23fd:	68 05 4e 00 00       	push   $0x4e05
    ...
    2411:	68 86 50 00 00       	push   $0x5086
    2416:	6a 01                	push   $0x1
    2418:	e8 48 1c 00 00       	call   4065 <printf>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    2428:	68 a1 50 00 00       	push   $0x50a1
    242d:	68 0d 50 00 00       	push   $0x500d
    ...
    2441:	68 ac 50 00 00       	push   $0x50ac
    2446:	6a 01                	push   $0x1
    2448:	e8 18 1c 00 00       	call   4065 <printf>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    2458:	68 a1 50 00 00       	push   $0x50a1
    245d:	68 32 50 00 00       	push   $0x5032
    ...
    2471:	68 d0 50 00 00       	push   $0x50d0
    2476:	6a 01                	push   $0x1
    2478:	e8 e8 1b 00 00       	call   4065 <printf>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    2488:	68 e8 4e 00 00       	push   $0x4ee8
    248d:	68 20 4e 00 00       	push   $0x4e20
    ...
    24a1:	68 f4 50 00 00       	push   $0x50f4
    24a6:	6a 01                	push   $0x1
    24a8:	e8 b8 1b 00 00       	call   4065 <printf>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    24b8:	68 0d 50 00 00       	push   $0x500d
    ...
    24cc:	68 16 51 00 00       	push   $0x5116
    24d1:	6a 01                	push   $0x1
    24d3:	e8 8d 1b 00 00       	call   4065 <printf>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    24e3:	68 32 50 00 00       	push   $0x5032
    ...
    24f7:	68 31 51 00 00       	push   $0x5131
    24fc:	6a 01                	push   $0x1
    24fe:	e8 62 1b 00 00       	call   4065 <printf>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    250e:	68 e8 4e 00 00       	push   $0x4ee8
    ...
    2522:	68 4c 51 00 00       	push   $0x514c
    2527:	6a 01                	push   $0x1
    2529:	e8 37 1b 00 00       	call   4065 <printf>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    2539:	68 32 50 00 00       	push   $0x5032
    ...
    254d:	68 69 51 00 00       	push   $0x5169
    2552:	6a 01                	push   $0x1
    2554:	e8 0c 1b 00 00       	call   4065 <printf>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    2564:	68 0d 50 00 00       	push   $0x500d
    ...
    2578:	68 85 51 00 00       	push   $0x5185
    257d:	6a 01                	push   $0x1
    257f:	e8 e1 1a 00 00       	call   4065 <printf>
  ...
  if(chdir("dd/ff") == 0){
    ...
    258f:	68 20 4e 00 00       	push   $0x4e20
    ...
    25a3:	68 a1 51 00 00       	push   $0x51a1
    25a8:	6a 01                	push   $0x1
    25aa:	e8 b6 1a 00 00       	call   4065 <printf>
  ...
  if(chdir("dd/xx") == 0){
    ...
    25ba:	68 b9 51 00 00       	push   $0x51b9
    ...
    25ce:	68 bf 51 00 00       	push   $0x51bf
    25d3:	6a 01                	push   $0x1
    25d5:	e8 8b 1a 00 00       	call   4065 <printf>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    25e5:	68 e8 4e 00 00       	push   $0x4ee8
    ...
    25f9:	68 15 4f 00 00       	push   $0x4f15
    25fe:	6a 01                	push   $0x1
    2600:	e8 60 1a 00 00       	call   4065 <printf>
  ...
  if(unlink("dd/ff") != 0){
    ...
    2610:	68 20 4e 00 00       	push   $0x4e20
    ...
    2624:	68 d7 51 00 00       	push   $0x51d7
    2629:	6a 01                	push   $0x1
    262b:	e8 35 1a 00 00       	call   4065 <printf>
  ...
  if(unlink("dd") == 0){
    ...
    263b:	68 05 4e 00 00       	push   $0x4e05
    ...
    264f:	68 ec 51 00 00       	push   $0x51ec
    2654:	6a 01                	push   $0x1
    2656:	e8 0a 1a 00 00       	call   4065 <printf>
  ...
  if(unlink("dd/dd") < 0){
    ...
    2666:	68 0c 52 00 00       	push   $0x520c
    ...
    267a:	68 12 52 00 00       	push   $0x5212
    267f:	6a 01                	push   $0x1
    2681:	e8 df 19 00 00       	call   4065 <printf>
  ...
  if(unlink("dd") < 0){
    ...
    2691:	68 05 4e 00 00       	push   $0x4e05
    ...
    26a5:	68 27 52 00 00       	push   $0x5227
    26aa:	6a 01                	push   $0x1
    26ac:	e8 b4 19 00 00       	call   4065 <printf>
  ...
  printf(1, "subdir ok\n");
    ...
    26bc:	68 39 52 00 00       	push   $0x5239
    26c1:	6a 01                	push   $0x1
    26c3:	e8 9d 19 00 00       	call   4065 <printf>
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    26d7:	68 44 52 00 00       	push   $0x5244
    26dc:	6a 01                	push   $0x1
    26de:	e8 82 19 00 00       	call   4065 <printf>
    26e3:	83 c4 10             	add    $0x10,%esp

  unlink("bigwrite");
    26e6:	83 ec 0c             	sub    $0xc,%esp
    26e9:	68 53 52 00 00       	push   $0x5253
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    270a:	68 53 52 00 00       	push   $0x5253
    ...
    2723:	68 5c 52 00 00       	push   $0x525c
    2728:	6a 01                	push   $0x1
    272a:	e8 36 19 00 00       	call   4065 <printf>
    ...
    2743:	ff 75 f4             	pushl  -0xc(%ebp)
    2746:	68 00 63 00 00       	push   $0x6300
    274b:	ff 75 ec             	pushl  -0x14(%ebp)
    ...
    2761:	ff 75 e8             	pushl  -0x18(%ebp)
    2764:	ff 75 f4             	pushl  -0xc(%ebp)
    2767:	68 74 52 00 00       	push   $0x5274
    276c:	6a 01                	push   $0x1
    276e:	e8 f2 18 00 00       	call   4065 <printf>
  ...
  printf(1, "bigwrite ok\n");
    ...
    27ba:	68 86 52 00 00       	push   $0x5286
    27bf:	6a 01                	push   $0x1
    27c1:	e8 9f 18 00 00       	call   4065 <printf>
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    27d5:	68 93 52 00 00       	push   $0x5293
    27da:	6a 01                	push   $0x1
    27dc:	e8 84 18 00 00       	call   4065 <printf>
    27e1:	83 c4 10             	add    $0x10,%esp

  unlink("bigfile");
    27e4:	83 ec 0c             	sub    $0xc,%esp
    27e7:	68 a1 52 00 00       	push   $0x52a1
  ...
  fd = open("bigfile", O_CREATE | O_RDWR);
    ...
    27fc:	68 a1 52 00 00       	push   $0x52a1
  ...
  if(fd < 0){
    ...
    2815:	68 a9 52 00 00       	push   $0x52a9
    281a:	6a 01                	push   $0x1
    281c:	e8 44 18 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 20; i++){
    ...
    286c:	68 bf 52 00 00       	push   $0x52bf
    2871:	6a 01                	push   $0x1
    2873:	e8 ed 17 00 00       	call   4065 <printf>
  ...
  fd = open("bigfile", 0);
    ...
    289b:	6a 00                	push   $0x0
    289d:	68 a1 52 00 00       	push   $0x52a1
  ...
  if(fd < 0){
    ...
    28b6:	68 d5 52 00 00       	push   $0x52d5
    28bb:	6a 01                	push   $0x1
    28bd:	e8 a3 17 00 00       	call   4065 <printf>
  ...
  for(i = 0; ; i++){
    ...
    28fc:	68 ea 52 00 00       	push   $0x52ea
    2901:	6a 01                	push   $0x1
    2903:	e8 5d 17 00 00       	call   4065 <printf>
    ...
    2922:	68 ff 52 00 00       	push   $0x52ff
    2927:	6a 01                	push   $0x1
    2929:	e8 37 17 00 00       	call   4065 <printf>
    ...
    296d:	68 13 53 00 00       	push   $0x5313
    2972:	6a 01                	push   $0x1
    2974:	e8 ec 16 00 00       	call   4065 <printf>
  ...
  if(total != 20*600){
    ...
    29ab:	68 2c 53 00 00       	push   $0x532c
    29b0:	6a 01                	push   $0x1
    29b2:	e8 ae 16 00 00       	call   4065 <printf>
  ...
  unlink("bigfile");
    ...
    29c2:	68 a1 52 00 00       	push   $0x52a1
    29c7:	e8 65 15 00 00       	call   3f31 <unlink>
    29cc:	83 c4 10             	add    $0x10,%esp

  printf(1, "bigfile test ok\n");
    29cf:	83 ec 08             	sub    $0x8,%esp
    29d2:	68 46 53 00 00       	push   $0x5346
    29d7:	6a 01                	push   $0x1
    29d9:	e8 87 16 00 00       	call   4065 <printf>
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    29ed:	68 57 53 00 00       	push   $0x5357
    29f2:	6a 01                	push   $0x1
    29f4:	e8 6c 16 00 00       	call   4065 <printf>
    29f9:	83 c4 10             	add    $0x10,%esp

  if(mkdir("12345678901234") != 0){
    29fc:	83 ec 0c             	sub    $0xc,%esp
    29ff:	68 66 53 00 00       	push   $0x5366
    ...
    2a13:	68 75 53 00 00       	push   $0x5375
    2a18:	6a 01                	push   $0x1
    2a1a:	e8 46 16 00 00       	call   4065 <printf>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2a2a:	68 94 53 00 00       	push   $0x5394
    ...
    2a3e:	68 b4 53 00 00       	push   $0x53b4
    2a43:	6a 01                	push   $0x1
    2a45:	e8 1b 16 00 00       	call   4065 <printf>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2a5a:	68 e4 53 00 00       	push   $0x53e4
  ...
  if(fd < 0){
    ...
    2a73:	68 14 54 00 00       	push   $0x5414
    2a78:	6a 01                	push   $0x1
    2a7a:	e8 e6 15 00 00       	call   4065 <printf>
  ...
  if(fd < 0){
    ...
    2ab3:	68 84 54 00 00       	push   $0x5484
    2ab8:	6a 01                	push   $0x1
    2aba:	e8 a6 15 00 00       	call   4065 <printf>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2aec:	68 dc 54 00 00       	push   $0x54dc
    2af1:	6a 01                	push   $0x1
    2af3:	e8 6d 15 00 00       	call   4065 <printf>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2b03:	68 0c 55 00 00       	push   $0x550c
    ...
    2b17:	68 2c 55 00 00       	push   $0x552c
    2b1c:	6a 01                	push   $0x1
    2b1e:	e8 42 15 00 00       	call   4065 <printf>
  ...
  printf(1, "fourteen ok\n");
    ...
    2b2e:	68 5d 55 00 00       	push   $0x555d
    2b33:	6a 01                	push   $0x1
    2b35:	e8 2b 15 00 00       	call   4065 <printf>
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    2b49:	68 6a 55 00 00       	push   $0x556a
    2b4e:	6a 01                	push   $0x1
    2b50:	e8 10 15 00 00       	call   4065 <printf>
    2b55:	83 c4 10             	add    $0x10,%esp
  if(mkdir("dots") != 0){
    2b58:	83 ec 0c             	sub    $0xc,%esp
    2b5b:	68 76 55 00 00       	push   $0x5576
    ...
    2b6f:	68 7b 55 00 00       	push   $0x557b
    2b74:	6a 01                	push   $0x1
    2b76:	e8 ea 14 00 00       	call   4065 <printf>
  ...
  if(chdir("dots") != 0){
    ...
    2b86:	68 76 55 00 00       	push   $0x5576
    ...
    2b9a:	68 8e 55 00 00       	push   $0x558e
    2b9f:	6a 01                	push   $0x1
    2ba1:	e8 bf 14 00 00       	call   4065 <printf>
  ...
  if(unlink(".") == 0){
    ...
    2bb1:	68 a7 4c 00 00       	push   $0x4ca7
    ...
    2bc5:	68 a1 55 00 00       	push   $0x55a1
    2bca:	6a 01                	push   $0x1
    2bcc:	e8 94 14 00 00       	call   4065 <printf>
  ...
  if(unlink("..") == 0){
    ...
    2bdc:	68 3a 48 00 00       	push   $0x483a
    ...
    2bf0:	68 af 55 00 00       	push   $0x55af
    2bf5:	6a 01                	push   $0x1
    2bf7:	e8 69 14 00 00       	call   4065 <printf>
  ...
  if(chdir("/") != 0){
    ...
    2c07:	68 8e 44 00 00       	push   $0x448e
    ...
    2c1b:	68 90 44 00 00       	push   $0x4490
    2c20:	6a 01                	push   $0x1
    2c22:	e8 3e 14 00 00       	call   4065 <printf>
  ...
  if(unlink("dots/.") == 0){
    ...
    2c32:	68 be 55 00 00       	push   $0x55be
    ...
    2c46:	68 c5 55 00 00       	push   $0x55c5
    2c4b:	6a 01                	push   $0x1
    2c4d:	e8 13 14 00 00       	call   4065 <printf>
  ...
  if(unlink("dots/..") == 0){
    ...
    2c5d:	68 dc 55 00 00       	push   $0x55dc
    ...
    2c71:	68 e4 55 00 00       	push   $0x55e4
    2c76:	6a 01                	push   $0x1
    2c78:	e8 e8 13 00 00       	call   4065 <printf>
  ...
  if(unlink("dots") != 0){
    ...
    2c88:	68 76 55 00 00       	push   $0x5576
    ...
    2c9c:	68 fc 55 00 00       	push   $0x55fc
    2ca1:	6a 01                	push   $0x1
    2ca3:	e8 bd 13 00 00       	call   4065 <printf>
  ...
  printf(1, "rmdot ok\n");
    ...
    2cb3:	68 11 56 00 00       	push   $0x5611
    2cb8:	6a 01                	push   $0x1
    2cba:	e8 a6 13 00 00       	call   4065 <printf>
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    2cce:	68 1b 56 00 00       	push   $0x561b
    2cd3:	6a 01                	push   $0x1
    2cd5:	e8 8b 13 00 00       	call   4065 <printf>
    2cda:	83 c4 10             	add    $0x10,%esp

  fd = open("dirfile", O_CREATE);
    2cdd:	83 ec 08             	sub    $0x8,%esp
    2ce0:	68 00 02 00 00       	push   $0x200
    2ce5:	68 28 56 00 00       	push   $0x5628
  ...
  if(fd < 0){
    ...
    2cfe:	68 30 56 00 00       	push   $0x5630
    2d03:	6a 01                	push   $0x1
    2d05:	e8 5b 13 00 00       	call   4065 <printf>
  ...
  if(chdir("dirfile") == 0){
    ...
    2d37:	68 47 56 00 00       	push   $0x5647
    2d3c:	6a 01                	push   $0x1
    2d3e:	e8 22 13 00 00       	call   4065 <printf>
  ...
  fd = open("dirfile/xx", 0);
    ...
    2d4e:	6a 00                	push   $0x0
    2d50:	68 61 56 00 00       	push   $0x5661
  ...
  if(fd >= 0){
    ...
    2d69:	68 6c 56 00 00       	push   $0x566c
    2d6e:	6a 01                	push   $0x1
    2d70:	e8 f0 12 00 00       	call   4065 <printf>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    2d85:	68 61 56 00 00       	push   $0x5661
  ...
  if(fd >= 0){
    ...
    2d9e:	68 6c 56 00 00       	push   $0x566c
    2da3:	6a 01                	push   $0x1
    2da5:	e8 bb 12 00 00       	call   4065 <printf>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    2db5:	68 61 56 00 00       	push   $0x5661
    ...
    2dc9:	68 8a 56 00 00       	push   $0x568a
    2dce:	6a 01                	push   $0x1
    2dd0:	e8 90 12 00 00       	call   4065 <printf>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    2de0:	68 61 56 00 00       	push   $0x5661
    ...
    2df4:	68 a7 56 00 00       	push   $0x56a7
    2df9:	6a 01                	push   $0x1
    2dfb:	e8 65 12 00 00       	call   4065 <printf>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    2e0b:	68 61 56 00 00       	push   $0x5661
    2e10:	68 c5 56 00 00       	push   $0x56c5
    ...
    2e24:	68 cc 56 00 00       	push   $0x56cc
    2e29:	6a 01                	push   $0x1
    2e2b:	e8 35 12 00 00       	call   4065 <printf>
  ...
  if(unlink("dirfile") != 0){
    ...
    2e3b:	68 28 56 00 00       	push   $0x5628
    ...
    2e4f:	68 eb 56 00 00       	push   $0x56eb
    2e54:	6a 01                	push   $0x1
    2e56:	e8 0a 12 00 00       	call   4065 <printf>
  ...
  fd = open(".", O_RDWR);
    ...
    2e66:	6a 02                	push   $0x2
    2e68:	68 a7 4c 00 00       	push   $0x4ca7
  ...
  if(fd >= 0){
    ...
    2e81:	68 04 57 00 00       	push   $0x5704
    2e86:	6a 01                	push   $0x1
    2e88:	e8 d8 11 00 00       	call   4065 <printf>
  ...
  fd = open(".", 0);
    ...
    2e98:	6a 00                	push   $0x0
    2e9a:	68 a7 4c 00 00       	push   $0x4ca7
  ...
  if(write(fd, "x", 1) > 0){
    ...
    2ead:	6a 01                	push   $0x1
    2eaf:	68 f3 48 00 00       	push   $0x48f3
    2eb4:	ff 75 f4             	pushl  -0xc(%ebp)
    ...
    2ec6:	68 23 57 00 00       	push   $0x5723
    2ecb:	6a 01                	push   $0x1
    2ecd:	e8 93 11 00 00       	call   4065 <printf>
  ...
  close(fd);
    ...
    2edd:	ff 75 f4             	pushl  -0xc(%ebp)
    2ee0:	e8 24 10 00 00       	call   3f09 <close>
    2ee5:	83 c4 10             	add    $0x10,%esp

  printf(1, "dir vs file OK\n");
    2ee8:	83 ec 08             	sub    $0x8,%esp
    2eeb:	68 37 57 00 00       	push   $0x5737
    2ef0:	6a 01                	push   $0x1
    2ef2:	e8 6e 11 00 00       	call   4065 <printf>
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    2f06:	68 47 57 00 00       	push   $0x5747
    2f0b:	6a 01                	push   $0x1
    2f0d:	e8 53 11 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    2f24:	68 58 57 00 00       	push   $0x5758
    ...
    2f38:	68 5e 57 00 00       	push   $0x575e
    2f3d:	6a 01                	push   $0x1
    2f3f:	e8 21 11 00 00       	call   4065 <printf>
    ...
    2f4f:	68 58 57 00 00       	push   $0x5758
    ...
    2f63:	68 72 57 00 00       	push   $0x5772
    2f68:	6a 01                	push   $0x1
    2f6a:	e8 f6 10 00 00       	call   4065 <printf>
  ...
  chdir("/");
    ...
    3015:	68 8e 44 00 00       	push   $0x448e
    301a:	e8 32 0f 00 00       	call   3f51 <chdir>
    301f:	83 c4 10             	add    $0x10,%esp
  printf(1, "empty file name OK\n");
    3022:	83 ec 08             	sub    $0x8,%esp
    3025:	68 8a 57 00 00       	push   $0x578a
    302a:	6a 01                	push   $0x1
    302c:	e8 34 10 00 00       	call   4065 <printf>
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    3040:	68 9e 57 00 00       	push   $0x579e
    3045:	6a 01                	push   $0x1
    3047:	e8 19 10 00 00       	call   4065 <printf>
  ...
  if(n == 1000){
    ...
    308d:	68 ac 57 00 00       	push   $0x57ac
    3092:	6a 01                	push   $0x1
    3094:	e8 cc 0f 00 00       	call   4065 <printf>
  ...
  for(; n > 0; n--){
    ...
    30ad:	68 ce 57 00 00       	push   $0x57ce
    30b2:	6a 01                	push   $0x1
    30b4:	e8 ac 0f 00 00       	call   4065 <printf>
  ...
  if(wait() != -1){
    ...
    30d8:	68 e2 57 00 00       	push   $0x57e2
    30dd:	6a 01                	push   $0x1
    30df:	e8 81 0f 00 00       	call   4065 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    30ef:	68 f5 57 00 00       	push   $0x57f5
    30f4:	6a 01                	push   $0x1
    30f6:	e8 6a 0f 00 00       	call   4065 <printf>
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    3107:	a1 d4 62 00 00       	mov    0x62d4,%eax
    310c:	83 ec 08             	sub    $0x8,%esp
    310f:	68 03 58 00 00       	push   $0x5803
    3114:	50                   	push   %eax
    3115:	e8 4b 0f 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    315e:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3163:	83 ec 0c             	sub    $0xc,%esp
    3166:	ff 75 d0             	pushl  -0x30(%ebp)
    3169:	ff 75 f4             	pushl  -0xc(%ebp)
    316c:	ff 75 f0             	pushl  -0x10(%ebp)
    316f:	68 0e 58 00 00       	push   $0x580e
    3174:	50                   	push   %eax
    3175:	e8 eb 0e 00 00       	call   4065 <printf>
  ...
  if(pid < 0){
    ...
    31ac:	a1 d4 62 00 00       	mov    0x62d4,%eax
    31b1:	83 ec 08             	sub    $0x8,%esp
    31b4:	68 29 58 00 00       	push   $0x5829
    31b9:	50                   	push   %eax
    31ba:	e8 a6 0e 00 00       	call   4065 <printf>
  ...
  if(c != a + 1){
    ...
    31f2:	a1 d4 62 00 00       	mov    0x62d4,%eax
    31f7:	83 ec 08             	sub    $0x8,%esp
    31fa:	68 40 58 00 00       	push   $0x5840
    31ff:	50                   	push   %eax
    3200:	e8 60 0e 00 00       	call   4065 <printf>
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    3254:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3259:	83 ec 08             	sub    $0x8,%esp
    325c:	68 5c 58 00 00       	push   $0x585c
    3261:	50                   	push   %eax
    3262:	e8 fe 0d 00 00       	call   4065 <printf>
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    32a5:	a1 d4 62 00 00       	mov    0x62d4,%eax
    32aa:	83 ec 08             	sub    $0x8,%esp
    32ad:	68 9a 58 00 00       	push   $0x589a
    32b2:	50                   	push   %eax
    32b3:	e8 ad 0d 00 00       	call   4065 <printf>
  ...
  if(c != a - 4096){
    ...
    32dd:	a1 d4 62 00 00       	mov    0x62d4,%eax
    32e2:	ff 75 e4             	pushl  -0x1c(%ebp)
    32e5:	ff 75 f4             	pushl  -0xc(%ebp)
    32e8:	68 b8 58 00 00       	push   $0x58b8
    32ed:	50                   	push   %eax
    32ee:	e8 72 0d 00 00       	call   4065 <printf>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3340:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3345:	ff 75 e4             	pushl  -0x1c(%ebp)
    3348:	ff 75 f4             	pushl  -0xc(%ebp)
    334b:	68 f0 58 00 00       	push   $0x58f0
    3350:	50                   	push   %eax
    3351:	e8 0f 0d 00 00       	call   4065 <printf>
  ...
  if(*lastaddr == 99){
    ...
    3368:	a1 d4 62 00 00       	mov    0x62d4,%eax
    336d:	83 ec 08             	sub    $0x8,%esp
    3370:	68 18 59 00 00       	push   $0x5918
    3375:	50                   	push   %eax
    3376:	e8 ea 0c 00 00       	call   4065 <printf>
  ...
  if(c != a){
    ...
    33be:	a1 d4 62 00 00       	mov    0x62d4,%eax
    33c3:	ff 75 e4             	pushl  -0x1c(%ebp)
    33c6:	ff 75 f4             	pushl  -0xc(%ebp)
    33c9:	68 48 59 00 00       	push   $0x5948
    33ce:	50                   	push   %eax
    33cf:	e8 91 0c 00 00       	call   4065 <printf>
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    33f9:	79 1b                	jns    3416 <sbrktest+0x315>
      printf(stdout, "fork failed\n");
    33fb:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3400:	83 ec 08             	sub    $0x8,%esp
    3403:	68 bd 44 00 00       	push   $0x44bd
    3408:	50                   	push   %eax
    3409:	e8 57 0c 00 00       	call   4065 <printf>
    ...
    3425:	a1 d4 62 00 00       	mov    0x62d4,%eax
    342a:	52                   	push   %edx
    342b:	ff 75 f4             	pushl  -0xc(%ebp)
    342e:	68 69 59 00 00       	push   $0x5969
    3433:	50                   	push   %eax
    3434:	e8 2c 0c 00 00       	call   4065 <printf>
    3439:	83 c4 10             	add    $0x10,%esp
      kill(ppid);
    343c:	83 ec 0c             	sub    $0xc,%esp
    343f:	ff 75 d4             	pushl  -0x2c(%ebp)
  ...
  if(pipe(fds) != 0){
    ...
    347a:	68 8e 48 00 00       	push   $0x488e
    347f:	6a 01                	push   $0x1
    3481:	e8 df 0b 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34d9:	6a 01                	push   $0x1
    34db:	68 f3 48 00 00       	push   $0x48f3
    34e0:	50                   	push   %eax
  ...
  if(c == (char*)0xffffffff){
    ...
    3581:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3586:	83 ec 08             	sub    $0x8,%esp
    3589:	68 82 59 00 00       	push   $0x5982
    358e:	50                   	push   %eax
    358f:	e8 d1 0a 00 00       	call   4065 <printf>
  ...
  printf(stdout, "sbrk test OK\n");
    35ce:	a1 d4 62 00 00       	mov    0x62d4,%eax
    35d3:	83 ec 08             	sub    $0x8,%esp
    35d6:	68 9d 59 00 00       	push   $0x599d
    35db:	50                   	push   %eax
    35dc:	e8 84 0a 00 00       	call   4065 <printf>
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    360f:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3614:	83 ec 08             	sub    $0x8,%esp
    3617:	68 ab 59 00 00       	push   $0x59ab
    361c:	50                   	push   %eax
    361d:	e8 43 0a 00 00       	call   4065 <printf>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    368d:	50                   	push   %eax
    368e:	68 ba 59 00 00       	push   $0x59ba
    ...
    36a0:	a1 d4 62 00 00       	mov    0x62d4,%eax
    36a5:	83 ec 08             	sub    $0x8,%esp
    36a8:	68 c5 59 00 00       	push   $0x59c5
    36ad:	50                   	push   %eax
    36ae:	e8 b2 09 00 00       	call   4065 <printf>
  ...
  printf(stdout, "validate ok\n");
    36ce:	a1 d4 62 00 00       	mov    0x62d4,%eax
    36d3:	83 ec 08             	sub    $0x8,%esp
    36d6:	68 de 59 00 00       	push   $0x59de
    36db:	50                   	push   %eax
    36dc:	e8 84 09 00 00       	call   4065 <printf>
...
bsstest(void)
{
  ...
  printf(stdout, "bss test\n");
    36ed:	a1 d4 62 00 00       	mov    0x62d4,%eax
    36f2:	83 ec 08             	sub    $0x8,%esp
    36f5:	68 eb 59 00 00       	push   $0x59eb
    36fa:	50                   	push   %eax
    36fb:	e8 65 09 00 00       	call   4065 <printf>
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    371b:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3720:	83 ec 08             	sub    $0x8,%esp
    3723:	68 f5 59 00 00       	push   $0x59f5
    3728:	50                   	push   %eax
    3729:	e8 37 09 00 00       	call   4065 <printf>
  ...
  printf(stdout, "bss test ok\n");
    3744:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3749:	83 ec 08             	sub    $0x8,%esp
    374c:	68 06 5a 00 00       	push   $0x5a06
    3751:	50                   	push   %eax
    3752:	e8 0e 09 00 00       	call   4065 <printf>
...
bigargtest(void)
{
  ...
  unlink("bigarg-ok");
    ...
    3766:	68 13 5a 00 00       	push   $0x5a13
  ...
  if(pid == 0){
    ...
    3791:	c7 04 85 40 aa 00 00 	movl   $0x5a20,0xaa40(,%eax,4)
    3798:	20 5a 00 00 
    for(i = 0; i < MAXARG-1; i++)
    ...
    3822:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3827:	83 ec 08             	sub    $0x8,%esp
    382a:	68 1a 5b 00 00       	push   $0x5b1a
    382f:	50                   	push   %eax
    3830:	e8 30 08 00 00       	call   4065 <printf>
  ...
  fd = open("bigarg-ok", 0);
    ...
    3845:	6a 00                	push   $0x0
    3847:	68 13 5a 00 00       	push   $0x5a13
  ...
  if(fd < 0){
    ...
    385d:	a1 d4 62 00 00       	mov    0x62d4,%eax
    3862:	83 ec 08             	sub    $0x8,%esp
    3865:	68 33 5b 00 00       	push   $0x5b33
    386a:	50                   	push   %eax
    386b:	e8 f5 07 00 00       	call   4065 <printf>
  ...
  unlink("bigarg-ok");
    ...
    3889:	68 13 5a 00 00       	push   $0x5a13
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    38aa:	68 48 5b 00 00       	push   $0x5b48
    38af:	6a 01                	push   $0x1
    38b1:	e8 af 07 00 00       	call   4065 <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    3996:	50                   	push   %eax
    3997:	68 55 5b 00 00       	push   $0x5b55
    399c:	6a 01                	push   $0x1
    399e:	e8 c2 06 00 00       	call   4065 <printf>
    ...
    39c9:	50                   	push   %eax
    39ca:	68 61 5b 00 00       	push   $0x5b61
    39cf:	6a 01                	push   $0x1
    39d1:	e8 8f 06 00 00       	call   4065 <printf>
    ...
    3a16:	ff 75 ec             	pushl  -0x14(%ebp)
    3a19:	68 71 5b 00 00       	push   $0x5b71
    3a1e:	6a 01                	push   $0x1
    3a20:	e8 40 06 00 00       	call   4065 <printf>
    3a25:	83 c4 10             	add    $0x10,%esp
    close(fd);
    3a28:	83 ec 0c             	sub    $0xc,%esp
    3a2b:	ff 75 e8             	pushl  -0x18(%ebp)
  ...
  printf(1, "fsfull test finished\n");
    ...
    3b3b:	68 81 5b 00 00       	push   $0x5b81
    3b40:	6a 01                	push   $0x1
    3b42:	e8 1e 05 00 00       	call   4065 <printf>
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    3b53:	a1 d8 62 00 00       	mov    0x62d8,%eax
    3b58:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    3b5e:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    3b63:	a3 d8 62 00 00       	mov    %eax,0x62d8
  return randstate;
    3b68:	a1 d8 62 00 00       	mov    0x62d8,%eax
}
    3b6d:	5d                   	pop    %ebp
    3b6e:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    3b83:	68 97 5b 00 00       	push   $0x5b97
    3b88:	6a 01                	push   $0x1
    3b8a:	e8 d6 04 00 00       	call   4065 <printf>
    3b8f:	83 c4 10             	add    $0x10,%esp

  if(open("usertests.ran", 0) >= 0){
    3b92:	83 ec 08             	sub    $0x8,%esp
    3b95:	6a 00                	push   $0x0
    3b97:	68 ab 5b 00 00       	push   $0x5bab
    ...
    3bab:	68 bc 5b 00 00       	push   $0x5bbc
    3bb0:	6a 01                	push   $0x1
    3bb2:	e8 ae 04 00 00       	call   4065 <printf>
  ...
  close(open("usertests.ran", O_CREATE));
    ...
    3bc7:	68 ab 5b 00 00       	push   $0x5bab
...
memset(void *dst, int c, uint n)
{
  ...
  stosb(dst, c, n);
    ...
    3d4c:	50                   	push   %eax
    3d4d:	ff 75 0c             	pushl  0xc(%ebp)
    3d50:	ff 75 08             	pushl  0x8(%ebp)
...
00003f81 <enable_sched_trace>:
SYSCALL(enable_sched_trace)
    3f81:	b8 16 00 00 00       	mov    $0x16,%eax
    3f86:	cd 40                	int    $0x40
    3f88:	c3                   	ret    

00003f89 <uprog_shut>:
SYSCALL(uprog_shut)
    3f89:	b8 17 00 00 00       	mov    $0x17,%eax
    3f8e:	cd 40                	int    $0x40
    3f90:	c3                   	ret    
...
putc(int fd, char c)
{
    ...
    3f94:	83 ec 18             	sub    $0x18,%esp
    3f97:	8b 45 0c             	mov    0xc(%ebp),%eax
    3f9a:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    3f9d:	83 ec 04             	sub    $0x4,%esp
    3fa0:	6a 01                	push   $0x1
    3fa2:	8d 45 f4             	lea    -0xc(%ebp),%eax
    3fa5:	50                   	push   %eax
    3fa6:	ff 75 08             	pushl  0x8(%ebp)
    3fa9:	e8 53 ff ff ff       	call   3f01 <write>
    3fae:	83 c4 10             	add    $0x10,%esp
}
    3fb1:	90                   	nop
    3fb2:	c9                   	leave  
    3fb3:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    3fba:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    3fc1:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    3fc5:	74 17                	je     3fde <printint+0x2a>
    3fc7:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    3fcb:	79 11                	jns    3fde <printint+0x2a>
    neg = 1;
    3fcd:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    3fd4:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fd7:	f7 d8                	neg    %eax
    3fd9:	89 45 ec             	mov    %eax,-0x14(%ebp)
    3fdc:	eb 06                	jmp    3fe4 <printint+0x30>
  } else {
    x = xx;
    3fde:	8b 45 0c             	mov    0xc(%ebp),%eax
    3fe1:	89 45 ec             	mov    %eax,-0x14(%ebp)
  }
  ...
  do{
    buf[i++] = digits[x % base];
    3feb:	8b 4d 10             	mov    0x10(%ebp),%ecx
    3fee:	8b 45 ec             	mov    -0x14(%ebp),%eax
    3ff1:	ba 00 00 00 00       	mov    $0x0,%edx
    3ff6:	f7 f1                	div    %ecx
    3ff8:	89 d1                	mov    %edx,%ecx
    3ffa:	8b 45 f4             	mov    -0xc(%ebp),%eax
    3ffd:	8d 50 01             	lea    0x1(%eax),%edx
    4000:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4003:	0f b6 91 dc 62 00 00 	movzbl 0x62dc(%ecx),%edx
    400a:	88 54 05 dc          	mov    %dl,-0x24(%ebp,%eax,1)
  }while((x /= base) != 0);
    400e:	8b 4d 10             	mov    0x10(%ebp),%ecx
    4011:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4014:	ba 00 00 00 00       	mov    $0x0,%edx
    4019:	f7 f1                	div    %ecx
    401b:	89 45 ec             	mov    %eax,-0x14(%ebp)
    401e:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4022:	75 c7                	jne    3feb <printint+0x37>
  if(neg)
    4024:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4028:	74 2d                	je     4057 <printint+0xa3>
    buf[i++] = '-';
    402a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    402d:	8d 50 01             	lea    0x1(%eax),%edx
    4030:	89 55 f4             	mov    %edx,-0xc(%ebp)
    4033:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)

  while(--i >= 0)
    4038:	eb 1d                	jmp    4057 <printint+0xa3>
    putc(fd, buf[i]);
    403a:	8d 55 dc             	lea    -0x24(%ebp),%edx
    403d:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4040:	01 d0                	add    %edx,%eax
    4042:	0f b6 00             	movzbl (%eax),%eax
    4045:	0f be c0             	movsbl %al,%eax
    4048:	83 ec 08             	sub    $0x8,%esp
    404b:	50                   	push   %eax
    404c:	ff 75 08             	pushl  0x8(%ebp)
    404f:	e8 3d ff ff ff       	call   3f91 <putc>
    4054:	83 c4 10             	add    $0x10,%esp
  while(--i >= 0)
    4057:	83 6d f4 01          	subl   $0x1,-0xc(%ebp)
    405b:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    405f:	79 d9                	jns    403a <printint+0x86>
}
    4061:	90                   	nop
    4062:	90                   	nop
    4063:	c9                   	leave  
...
printf(int fd, char *fmt, ...)
{
    ...
    4068:	83 ec 28             	sub    $0x28,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    406b:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    4072:	8d 45 0c             	lea    0xc(%ebp),%eax
    4075:	83 c0 04             	add    $0x4,%eax
    4078:	89 45 e8             	mov    %eax,-0x18(%ebp)
  for(i = 0; fmt[i]; i++){
    407b:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
    4082:	e9 59 01 00 00       	jmp    41e0 <printf+0x17b>
    c = fmt[i] & 0xff;
    4087:	8b 55 0c             	mov    0xc(%ebp),%edx
    408a:	8b 45 f0             	mov    -0x10(%ebp),%eax
    408d:	01 d0                	add    %edx,%eax
    408f:	0f b6 00             	movzbl (%eax),%eax
    4092:	0f be c0             	movsbl %al,%eax
    4095:	25 ff 00 00 00       	and    $0xff,%eax
    409a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(state == 0){
    409d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    40a1:	75 2c                	jne    40cf <printf+0x6a>
      if(c == '%'){
    40a3:	83 7d e4 25          	cmpl   $0x25,-0x1c(%ebp)
    40a7:	75 0c                	jne    40b5 <printf+0x50>
        state = '%';
    40a9:	c7 45 ec 25 00 00 00 	movl   $0x25,-0x14(%ebp)
    40b0:	e9 27 01 00 00       	jmp    41dc <printf+0x177>
      } else {
        putc(fd, c);
    40b5:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    40b8:	0f be c0             	movsbl %al,%eax
    40bb:	83 ec 08             	sub    $0x8,%esp
    40be:	50                   	push   %eax
    40bf:	ff 75 08             	pushl  0x8(%ebp)
    40c2:	e8 ca fe ff ff       	call   3f91 <putc>
    40c7:	83 c4 10             	add    $0x10,%esp
    40ca:	e9 0d 01 00 00       	jmp    41dc <printf+0x177>
      }
    } else if(state == '%'){
    40cf:	83 7d ec 25          	cmpl   $0x25,-0x14(%ebp)
    40d3:	0f 85 03 01 00 00    	jne    41dc <printf+0x177>
      if(c == 'd'){
    40d9:	83 7d e4 64          	cmpl   $0x64,-0x1c(%ebp)
    40dd:	75 1e                	jne    40fd <printf+0x98>
        printint(fd, *ap, 10, 1);
    40df:	8b 45 e8             	mov    -0x18(%ebp),%eax
    40e2:	8b 00                	mov    (%eax),%eax
    40e4:	6a 01                	push   $0x1
    40e6:	6a 0a                	push   $0xa
    40e8:	50                   	push   %eax
    40e9:	ff 75 08             	pushl  0x8(%ebp)
    40ec:	e8 c3 fe ff ff       	call   3fb4 <printint>
    40f1:	83 c4 10             	add    $0x10,%esp
        ap++;
    40f4:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    40f8:	e9 d8 00 00 00       	jmp    41d5 <printf+0x170>
      } else if(c == 'x' || c == 'p'){
    40fd:	83 7d e4 78          	cmpl   $0x78,-0x1c(%ebp)
    4101:	74 06                	je     4109 <printf+0xa4>
    4103:	83 7d e4 70          	cmpl   $0x70,-0x1c(%ebp)
    4107:	75 1e                	jne    4127 <printf+0xc2>
        printint(fd, *ap, 16, 0);
    4109:	8b 45 e8             	mov    -0x18(%ebp),%eax
    410c:	8b 00                	mov    (%eax),%eax
    410e:	6a 00                	push   $0x0
    4110:	6a 10                	push   $0x10
    4112:	50                   	push   %eax
    4113:	ff 75 08             	pushl  0x8(%ebp)
    4116:	e8 99 fe ff ff       	call   3fb4 <printint>
    411b:	83 c4 10             	add    $0x10,%esp
        ap++;
    411e:	83 45 e8 04          	addl   $0x4,-0x18(%ebp)
    4122:	e9 ae 00 00 00       	jmp    41d5 <printf+0x170>
      } else if(c == 's'){
    4127:	83 7d e4 73          	cmpl   $0x73,-0x1c(%ebp)
    412b:	75 43                	jne    4170 <printf+0x10b>
        s = (char*)*ap;
    ...
    413d:	75 25                	jne    4164 <printf+0xff>
          s = "(null)";
    413f:	c7 45 f4 e6 5b 00 00 	movl   $0x5be6,-0xc(%ebp)
        while(*s != 0){
    4146:	eb 1c                	jmp    4164 <printf+0xff>
          putc(fd, *s);
    4148:	8b 45 f4             	mov    -0xc(%ebp),%eax
    414b:	0f b6 00             	movzbl (%eax),%eax
    414e:	0f be c0             	movsbl %al,%eax
    4151:	83 ec 08             	sub    $0x8,%esp
    4154:	50                   	push   %eax
    4155:	ff 75 08             	pushl  0x8(%ebp)
    4158:	e8 34 fe ff ff       	call   3f91 <putc>
    415d:	83 c4 10             	add    $0x10,%esp
          s++;
    ...
    41a6:	e8 e6 fd ff ff       	call   3f91 <putc>
    41ab:	83 c4 10             	add    $0x10,%esp
    41ae:	eb 25                	jmp    41d5 <printf+0x170>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    41b0:	83 ec 08             	sub    $0x8,%esp
    41b3:	6a 25                	push   $0x25
    41b5:	ff 75 08             	pushl  0x8(%ebp)
    41b8:	e8 d4 fd ff ff       	call   3f91 <putc>
    41bd:	83 c4 10             	add    $0x10,%esp
        putc(fd, c);
    41c0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    41c3:	0f be c0             	movsbl %al,%eax
    41c6:	83 ec 08             	sub    $0x8,%esp
    41c9:	50                   	push   %eax
    41ca:	ff 75 08             	pushl  0x8(%ebp)
    41cd:	e8 bf fd ff ff       	call   3f91 <putc>
    41d2:	83 c4 10             	add    $0x10,%esp
      }
      state = 0;
    41d5:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  for(i = 0; fmt[i]; i++){
    41dc:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
    41e0:	8b 55 0c             	mov    0xc(%ebp),%edx
    41e3:	8b 45 f0             	mov    -0x10(%ebp),%eax
    41e6:	01 d0                	add    %edx,%eax
    41e8:	0f b6 00             	movzbl (%eax),%eax
    41eb:	84 c0                	test   %al,%al
    41ed:	0f 85 94 fe ff ff    	jne    4087 <printf+0x22>
    }
  }
}
    41f3:	90                   	nop
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    4227:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    422a:	72 1a                	jb     4246 <free+0x4f>
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    4241:	39 45 f8             	cmp    %eax,-0x8(%ebp)
    4244:	73 ca                	jae    4210 <free+0x19>
      break;
  ...
  freep = p;
    ...
    42d1:	a3 c8 aa 00 00       	mov    %eax,0xaac8
}
    42d6:	90                   	nop
    42d7:	c9                   	leave  
    42d8:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    42f8:	50                   	push   %eax
    42f9:	e8 6b fc ff ff       	call   3f69 <sbrk>
  ...
  return freep;
    4332:	a1 c8 aa 00 00       	mov    0xaac8,%eax
}
    4337:	c9                   	leave  
    4338:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    434e:	a1 c8 aa 00 00       	mov    0xaac8,%eax
    4353:	89 45 f0             	mov    %eax,-0x10(%ebp)
    4356:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    435a:	75 23                	jne    437f <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    435c:	c7 45 f0 c0 aa 00 00 	movl   $0xaac0,-0x10(%ebp)
    4363:	8b 45 f0             	mov    -0x10(%ebp),%eax
    4366:	a3 c8 aa 00 00       	mov    %eax,0xaac8
    436b:	a1 c8 aa 00 00       	mov    0xaac8,%eax
    4370:	a3 c0 aa 00 00       	mov    %eax,0xaac0
    base.s.size = 0;
    4375:	c7 05 c4 aa 00 00 00 	movl   $0x0,0xaac4
    437c:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    438d:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    4390:	77 4d                	ja     43df <malloc+0xa6>
      if(p->s.size == nunits)
    4392:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4395:	8b 40 04             	mov    0x4(%eax),%eax
    4398:	39 45 ec             	cmp    %eax,-0x14(%ebp)
    ...
    43d2:	a3 c8 aa 00 00       	mov    %eax,0xaac8
      return (void*)(p + 1);
    ...
    if(p == freep)
    43df:	a1 c8 aa 00 00       	mov    0xaac8,%eax
